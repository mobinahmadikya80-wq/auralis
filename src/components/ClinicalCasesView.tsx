        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-xs font-semibold border border-emerald-500/20">
              ...
              <span>موارد واقعی بیماران و استدلال تشخیصی</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-zinc-900 dark:text-white font-display mt-2">
              بسته موارد بالینی و دور ویزیت
            </h2>
            <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">
              تاریخچه بیماران واقعی، یافته‌های اتوسکوپی، نمودار آدیومتری و منحنی تمپانومتری رو بررسی کن. قضاوت بالینی‌ت رو با سوالات تعاملی محک بزن.
            </p>
          </div>

          {/* Case Selector Dropdown */}
          <div className="w-full md:w-80">
            <label className="text-xs font-bold text-zinc-400 uppercase">انتخاب مورد بالینی:</label>
            <select
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-3">
              <span className="text-xs font-bold text-cyan-500 uppercase tracking-wider flex items-center gap-1.5">
                <User className="w-4 h-4" /> مشخصات بیمار
              </span>
              <span className="text-xs font-mono font-semibold text-zinc-500">
                {selectedCase.patientAge} ساله • {selectedCase.patientGender}
              </span>
            </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-4">
            <h3 className="text-sm font-bold text-zinc-900 dark:text-white uppercase tracking-wider flex items-center gap-2">
              ...
              نتایج بسته آزمون‌های تشخیصی بالینی
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
                <span className="font-bold text-cyan-500 uppercase">اتوسکوپی</span>
              ...
              <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
                <span className="font-bold text-blue-500 uppercase">تمپانومتری</span>
                <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed">
                  راست: <strong>{selectedCase.tympanometry.typeRight}</strong> ({selectedCase.tympanometry.complianceRight} ml)<br/>
                  چپ: <strong>{selectedCase.tympanometry.typeLeft}</strong> ({selectedCase.tympanometry.complianceLeft} ml)
                </p>
              </div>

              <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
                <span className="font-bold text-purple-500 uppercase">رفلکس آکوستیک</span>
                <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
                <span className="font-bold text-amber-500 uppercase">آزمون OAE</span>
                <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-3">
              <span className="text-xs font-bold text-emerald-500 uppercase tracking-wider flex items-center gap-1.5">
                <HelpCircle className="w-4 h-4" /> سوالات مورد بالینی
              </span>
            </div>
            ...
            <div className="pt-2">
              {!showDiagnosticAnswer ? (
                ...
                >
                  ...
                  <span>نمایش تشخیص نهایی و برنامه درمان</span>
                </button>
              ) : (
                <div className="p-5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-950 dark:text-emerald-100 space-y-4 animate-in fade-in duration-200">
                  <div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">تشخیص نهایی</span>
                  ...
                  <div className="space-y-1">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">برنامه مدیریت</span>
